                    ...
                    <div key={question._id}>
                      ...
                      <div className="flex flex-col md:flex-row gap-2 mt-4">
                        {nextIndex === (quiz?.questions.length ?? 0) - 1 ? (
                          <input
                            type="submit"
                            className="flex items-center justify-center text-center cursor-pointer bg-slate-700 text-white p-2 w-full rounded-md font-semibold gap-x-2 hover:bg-slate-800 transition-colors duration-300 ease-in-out"
                            value={"Finzalizar"}
                          />
                        ) : (
                          <button
